...
const FrontendContainer = React.createClass({
  contextTypes: {
  ...
  handleClick(e){
    console.log('clicked topic option', e.target.innerText);
  ...
  render() {
    return (
      <div>
        <h1 style={display.title}>{this.capitalizeTitle(this.state.topic)} Web Development</h1>
        <h3 style={display.subtitle}>Making the Web Dynamic</h3>
        <hr/>
        <div>
          {
